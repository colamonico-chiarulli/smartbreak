        ...
        <div class="card-body">
            <form action="{{ route('users.import-csv') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <p>Il file csv degli studenti deve avere i seguenti campi: <strong>first_name,last_name,email,class_id,site_id</strong><br>
                    Si suggerisce di non superare le <strong>200 righe</strong> per file, in modo da non incorrere nel timeout durante l'importazione</p>
