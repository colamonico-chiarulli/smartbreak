 ...
 * -----
 * Last Modified: 	May 30th 2024 07:56:00 pm
 * Modified By: 	Rino Andriano <andriano@colamonicochiarulli.edu.it>
 * ----------	-------------	----------------------------------
 * 2024-05-30   R. Andriano     Seeder for Demo SmartBreak site
 * 2021-05-21	R. Andriano	    Fix: Seders classes, users sample data
...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Generating (5..15) Fake students for each classroom
